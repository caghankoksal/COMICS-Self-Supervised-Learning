...
def gimme_save_string(opt):
    ...
    base_str = ''
    for key, value in zip(opt._fields, opt):
        base_str += str(key)
...
class InfoPlotter():
    ...
    def make_plot(self, x, y1, y2, labels=['Training Loss', 'Validation Acc']):
        plt.style.use('ggplot')
        print("Make Plot ", "X : ",x , "Y1 : ",y1, "Y2 : ",y2)
        f,ax = plt.subplots(1)
        ...
        axx.set(xlabel ="Epochs", ylabel = labels[1])    
